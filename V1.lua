lib = loadstring(game:HttpGet"https://raw.githubusercontent.com/TERMINALRUNZYOU/BigDaddyv1/main/bigdaddy")()
local win = lib:CreateWindow("Just for you daddy 😱 - ", Vector2.new(492, 598), Enum.KeyCode.RightShift)
local tab1 = win:CreateTab("Aim")
local tab2 = win:CreateTab("Blatant")
local tab3 = win:CreateTab("Blatant2")
